import { parse } from "npm:querystring";
import {
  SlackModalPayload,
  SlackPayload,
  SlackSlashCommandPayload,
} from "../types/slack.models.ts";
import { slackApi, verifySlackRequest } from "./slackApi.ts";
import { blocks, modal } from "./slack.constructor.ts";
...
export const handler = async (event: unknown) => {
  console.log("LOGGED OUT SOMETHING FUNNY: event", event);
